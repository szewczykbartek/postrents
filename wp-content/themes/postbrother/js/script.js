    ...
    function Control() {
        ...
        $.extend(this, {
            ...
            PageFunctionStart: function() {
                ...
                $(document).on('click', '.actBlogOpen', function(event) {
                  href = $(this).attr('href');
                  History.pushState({
                      rand: Math.random()
                  }, null, href);
                ...
                $(document).on('click', '.actBlogClose', function(event) {
                  $('body').removeClass('overlay');

                  History.pushState({
                      rand: Math.random()
                  }, null, domainHome + '/news-press/');
                })



                $(document).on('click', '.actBlogSocial', function(event) {
                  href = $(this).attr('href');
                  window.open(href, 'Social', 'toolbar=no, location=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=550, height=350');
                  return false;
                });
