// click > mapSoho.setCenter(new google.maps.LatLng(50, -50));
var ControlPack;
        ...
        $.extend(this, {
            ...
            PageFunctionStart: function() {
                ...
                $(document).on('click', '.Page.Contact .Select .Dropdown a', function(event) {
                    val = $(this).data('value');
                    $('.Page.Contact .Select .SelectAct .Value').html(val);
    ...
    if (!$('body').hasClass('ieOld')) {
        ...
        History.Adapter.bind(window, 'statechange', function() {
            setTimeout(function() {
                ...
                $('.actionChangeClassPhone').attr('id','PhoneDiv');
                if(slugLast == 'goldtex'){
                    $('.actionChangeClassPhone').attr('id','PhoneDiv1');
                }
